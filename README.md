...
> Answer: routing between views is faster which leads to smoother site experience
- [ ] What does AJAX stand for?
> Answer: asynchronous JavaScript and XML
- [ ] What are `controlled components` in React?
> Answer: a component whos value is controlled and updated with its state
- [ ] Name three tools/libraries for making AJAX requests.
> Answer: fetch, axios, and jquery $.ajax
